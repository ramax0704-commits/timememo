...
export const RABBITS = [
  ...
  },
  {
    ...
    criteria: '사람과 함께한 시간이 하루의 절반 이상이거나 그날 가장 긴 덩어리(모임·회식·나들이). 밥 한 끼·잠깐의 연락은 아님',
  },
  {
    ...
    criteria: '협업·회의·같이 굴린 일이 하루의 중심(기록 여럿에 걸쳐)',
  },
  ...
  },
  {
    ...
    criteria: '독서·영화·드라마·OTT·요가·산책·쉼·회복·낮잠이 하루의 중심 (누구와 함께였든)',
  },
  {
